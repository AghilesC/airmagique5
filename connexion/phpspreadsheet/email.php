...
$mail->setFrom('rapport-inventaire@ctiai.com', 'Inventaire CTIAI');
$mail->addAddress('achaouche@ctiai.com');
$mail->Subject = "Rapport d'inventaire quotidien " . date("d/m/Y") . "";
$mail->Body = "Bonjour,

Veuillez trouver le rapport d'inventaire du " . date("d/m/Y") . " en pièce jointe.
...
$excelFileName = 'rapport_inventaire_' . $todayDate . '.xlsx';
