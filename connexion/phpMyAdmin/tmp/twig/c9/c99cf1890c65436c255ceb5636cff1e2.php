...
class __TwigTemplate_a7a5979345ab713444187b9b17fa6cc4 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "C:\\inetpub\\wwwroot\\inventaire\\connexion\\phpMyAdmin\\templates\\database\\export\\index.twig");
    }
}
